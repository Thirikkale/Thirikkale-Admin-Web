...
export default function DriverReports() {
    ...
    useEffect(() => {
        setPageHeader({
            ...
            subtitle: 'View and manage reports related to drivers.',
        });
    }, [setPageHeader]);
        ...
        <div className="space-y-6 max-w-full overflow-hidden">
            <div className="bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden">
                ...
                <div className="p-6 border-b border-gray-200">
                    <input
                        type="text"
                        placeholder="Search by driver, reporter, reason, city, or ID"
                        value={search}
                            ...
                            <div className="grid gap-4 px-6 py-4 items-center" style={{ gridTemplateColumns: '0.8fr 1.7fr 1.7fr 1.5fr 0.8fr 1fr' }}>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex-shrink-0">
                                            <p className="text-sm font-semibold text-gray-900 truncate">{r.driver}</p>
                                        </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    <div className="flex-shrink-0">
                                        <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center text-lg border border-gray-300">
                                            {/* Placeholder avatar for reporter */}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {/* Demo/placeholder city for reporter */}
                                        <p className="text-xs text-gray-500 truncate">{r.city} {/* or reporter's city if available */}</p>
                                        <div className="flex items-center space-x-2 mt-1">
                                            <span className="text-xs text-gray-400">Reporter ID:</span>
                                            <span className="text-xs font-medium text-gray-700 bg-gray-100 px-2 py-1 rounded">
                                                {`R${r.id.slice(-3)}`}
                                            </span>
                                        </div>
                                        {/* Demo/placeholder date for reporter */}
                                        <p className="text-xs text-gray-400 truncate">{r.date}</p>
                                    </div>
                                </div>
                                {/* Reason Column */}
